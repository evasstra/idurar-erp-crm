...
const updateManySetting = async (req, res) => {
  ...
  for (const setting of settings) {
    ...
    // Define the update operation - Simplified $setOnInsert
    const updateOperation = {
      $set: { settingValue: settingValue },
      $setOnInsert: {
        settingCategory: settingCategory, // Ensure category is set on insert
        // Let Mongoose handle other schema defaults automatically during upsert
      },
    };
