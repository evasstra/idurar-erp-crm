...
const updateManySetting = async (req, res) => {
  ...
  for (const setting of settings) {
    ...
    // Define the update operation - Explicitly set required fields in $set
    const updateOperation = {
      $set: {
        settingValue: settingValue,
        settingKey: settingKey, // Explicitly set required field
        settingCategory: settingCategory, // Explicitly set required field
      },
      // Removed $setOnInsert
    };
